...
class CustomTextFormField extends StatelessWidget {
  ...
  InputDecoration _inputDecoration(BuildContext context) {
    return InputDecoration(
      ...
      disabledBorder:_cutomBorder(ColorManager.primary, 2) ,
      enabledBorder: _cutomBorder(ColorManager.primary, 2),
      focusedBorder: _cutomBorder(ColorManager.primary, 2),
      focusedErrorBorder: _cutomBorder(ColorManager.primary, 2),
